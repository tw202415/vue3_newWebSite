<template>
  <div class="min-h-screen bg-white transition-colors duration-300">
    ...
    <main class="pb-16 md:pb-0">
      <ResponsiveComponent
        :desktop-component="DesktopKorea"
        :mobile-component="MobileKorea"
      />
...
import DesktopKorea from '@/components/desktop/shippings/Korea.vue';

// Mobile Components
import MobileHeader from '@/components/mobile/Header.vue';
import MobileKorea from '@/components/mobile/shippings/Korea.vue';
