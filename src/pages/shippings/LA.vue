<template>
  <div class="min-h-screen bg-white transition-colors duration-300">
    ...
    <main class="pb-16 md:pb-0">
      <ResponsiveComponent
        :desktop-component="DesktopShippingLA"
        :mobile-component="MobileShippingLA"
      />
...
import DesktopShippingLA from '@/components/desktop/shippings/LA.vue';

// Mobile Components
import MobileHeader from '@/components/mobile/Header.vue';
import MobileShippingLA from '@/components/mobile/shippings/LA.vue';
