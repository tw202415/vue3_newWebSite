<template>
  <div class="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
    ...
    <main class="pb-16 md:pb-0">
      <ResponsiveComponent
        :desktop-component="DesktopJapan"
        :mobile-component="MobileJapan"
      />
...
import DesktopJapan from '@/components/desktop/shippings/JapanEmsAir.vue';

// Mobile Components
import MobileHeader from '@/components/mobile/Header.vue';
import MobileJapan from '@/components/mobile/shippings/JapanEmsAir.vue';
