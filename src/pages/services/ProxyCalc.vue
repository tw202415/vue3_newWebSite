<template>
  <div class="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
    ...
    <main class="pb-16 md:pb-0">
      <ResponsiveComponent
        :desktop-component="DesktopProxyCalc"
        :mobile-component="MobileProxyCalc"
      />
...
import DesktopProxyCalc from '@/components/desktop/services/ProxyCalc.vue';

// Mobile Components
import MobileHeader from '@/components/mobile/Header.vue';
import MobileProxyCalc from '@/components/mobile/services/ProxyCalc.vue';
