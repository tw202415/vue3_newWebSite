<template>
  <div class="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
    ...
    <main class="pb-16 md:pb-0">
      <ResponsiveComponent
        :desktop-component="DesktopITT"
        :mobile-component="MobileITT"
      />
...
import DesktopITT from '@/components/desktop/services/ITT.vue';

// Mobile Components
import MobileHeader from '@/components/mobile/Header.vue';
import MobileITT from '@/components/mobile/services/ITT.vue';
