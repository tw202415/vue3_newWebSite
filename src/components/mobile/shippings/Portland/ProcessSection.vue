<template>
  <h2 class="text-2xl font-bold text-cyan-400 font-mono tracking-wider mb-2">{{ t('shipping.routes.countries.menu1.outline2') }}</h2>
  <div class="space-y-4">
    <div 
...
const processItems = computed(() => [
  {
    item: t('shipping.routes.countries.menu1.item16'),
    content: [
        t('shipping.routes.countries.menu1.content16.row1'),
        t('shipping.routes.countries.menu1.content16.row2'),
        t('shipping.routes.countries.menu1.content16.row3'),
        t('shipping.routes.countries.menu1.content16.row4'),
        t('shipping.routes.countries.menu1.content16.row5'),
        t('shipping.routes.countries.menu1.content16.row6'),
        t('shipping.routes.countries.menu1.content16.row7'),
    ]
  },
  {
    item: t('shipping.routes.countries.menu1.item9'),
    content: [
        t('shipping.routes.countries.menu1.content17.row1'),
        t('shipping.routes.countries.menu1.content17.row2'),
        t('shipping.routes.countries.menu1.content17.row3'),
        t('shipping.routes.countries.menu1.content17.row4'),
        t('shipping.routes.countries.menu1.content17.row5'),
        t('shipping.routes.countries.menu1.content17.row6')
    ]
  },
  {
