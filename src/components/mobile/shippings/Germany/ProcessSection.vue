...
const processItems = computed(() => [
  {
    item: t('shipping.routes.countries.menu1.item17'),
    content: [
        t('shipping.routes.countries.menu1.content18.row1'),
        t('shipping.routes.countries.menu1.content18.row2'),
        t('shipping.routes.countries.menu1.content18.row3'),
        t('shipping.routes.countries.menu1.content18.row4'),
        t('shipping.routes.countries.menu1.content18.row5'),
        t('shipping.routes.countries.menu1.content18.row6'),
        t('shipping.routes.countries.menu1.content18.row7'),
    ]
  },
  {
    item: t('shipping.routes.countries.menu1.item9'),
    content: [
        t('shipping.routes.countries.menu1.content19.row1'),
        t('shipping.routes.countries.menu1.content19.row2'),
        t('shipping.routes.countries.menu1.content19.row3'),
        t('shipping.routes.countries.menu1.content19.row4'),
        t('shipping.routes.countries.menu1.content19.row5'),
        t('shipping.routes.countries.menu1.content19.row6'),
    ]
  },
  {
