    ...
    <div class="space-y-4">
      ...
      >
        ...
        <div v-if="index === 1" v-show="openFaqs[index]" class="p-6 pt-0 border-t border-cyan-500/20">
          <h2 class="text-cyan-400 font-bold mt-2">{{ t(`shipping.routes.countries.menu2.subtitle11`) }}</h2>
          <div class="overflow-x-auto">
            <table class="w-full border-collapse">
              <thead>
                <tr class="bg-gray-800/70 text-white">
    ...
    <div class="space-y-4">
      ...
      >
          ...
          <div class="overflow-x-auto">
            <table class="w-full border-collapse">
              ...
              <tbody>
                ...
                >
                  <td class="p-4 text-white">{{ item.currency }}</td>
                  <td class="p-4 text-white">{{ item.explain }}</td>
                  <td class="p-4 text-white">{{ item.packagingFee }}</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div v-if="index === 2" v-show="openFaqs3[index]" class="p-6 pt-0 border-t border-cyan-500/20">
          <div class="overflow-x-auto">
            <table class="w-full border-collapse">
              ...
              <tbody>
                ...
                >
                  <td class="p-4 text-white">{{ item.currency }}</td>
                  <td class="p-4 text-white">{{ item.behalf }}</td>
                  <td class="p-4 text-cyan-400 font-medium">{{ item.price }}</td>
                </tr>
              </tbody>
            </table>
          ...
          <p class="mt-2 text-white"> 
            {{ t('shipping.routes.countries.menu2.example') }} : {{ t('shipping.routes.countries.menu2.exampleContent23') }}{{ t('shipping.routes.countries.menu2.webRate') }}{{  t('shipping.routes.countries.menu2.payType1') }}
          </p>
          <p class="text-cyan-400 mt-2">{{ t('shipping.routes.notice') }}</p>
          <p class="mt-2 text-white" v-for="(i, idx) in item.content">
              {{ idx + 1 }}.{{ i }}
            ...
            <table class="w-full border-collapse">
              ...
              <tbody>
                <tr 
                  ...
                  class="border-b border-cyan-500/10 hover:bg-gray-800/30"
                >
                  <td class="p-4 text-white">{{ item.type }}</td>
                  <td class="p-4 text-white">60NTD</td>
                  <td class="p-4 text-white">300NTD</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table class="w-full border-collapse">
              ...
              <tbody>
                <tr 
                  ...
                  class="border-b border-cyan-500/10 hover:bg-gray-800/30"
                >
                  <td class="p-4 text-white">{{ item.rate }}</td>
                  <td class="p-4 text-white">1.5%</td>
                  <td class="p-4 text-white">2%</td>
                  <td class="p-4 text-white">2.5%</td>
                  <td class="p-4 text-white">3%</td>
                  <td class="p-4 text-white">4%</td>
                  <td class="p-4 text-white">5%</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div class="overflow-x-auto">
            <table class="w-full border-collapse">
              ...
              <tbody>
                ...
                >
                  <td class="p-4 text-white">{{ item.currency }}</td>
                  <td class="p-4 text-white">{{ item.time }}</td>
                  <td class="p-4 text-white">{{ item.storeFee }}</td>
                </tr>
              </tbody>
            </table>
          </div>
          <p class="mt-2 text-white"> 
            {{ t('shipping.routes.countries.menu2.example') }} : {{ t('shipping.routes.countries.menu2.exampleContent24') }}
          </p>
          <p class="text-cyan-400 mt-2">{{ t('shipping.routes.notice') }}</p>
          <p class="mt-2 text-white" v-for="(i, idx) in item.content">
              {{ idx + 1 }}.{{ i }}
...
const items = computed(() => [
  ...
  },
  {
    ...
    content: [
        t('shipping.routes.countries.menu2.content34.row1'),
        t('shipping.routes.countries.menu2.content34.row2'),
        t('shipping.routes.countries.menu2.content34.row3'),
        t('shipping.routes.countries.menu2.content34.row4'),
        t('shipping.routes.countries.menu2.content34.row5'),
        t('shipping.routes.countries.menu2.content34.row6'),
        t('shipping.routes.countries.menu2.content34.row7'),
        t('shipping.routes.countries.menu2.content34.row8')
    ]
  },
  {
...
const items2 = computed(() => [
  {
    ...
    content: [
        t('shipping.routes.countries.menu2.content35.row1'),
        t('shipping.routes.countries.menu2.content35.row2'),
        t('shipping.routes.countries.menu2.content35.row3'),
        t('shipping.routes.countries.menu2.content35.row4'),
    ]
  },
  {
    item: t('shipping.routes.countries.menu2.item8'),
    content: [
        t('shipping.routes.countries.menu2.content36.row1'),
        t('shipping.routes.countries.menu2.content36.row2'),
        t('shipping.routes.countries.menu2.content36.row3'),
    ]
  },
])
...
const items3 = computed(() => [
  ...
  {
    item: t('shipping.routes.countries.menu2.item26'),
    content: [
...
const pricingItems = computed(() => [
  {
    ...
    weight: t('shipping.routes.countries.menu2.firstHalfKG'),
    price: 'NTD ' + feeResult.value?.warehouses?.[0]?.methods?.[0]?.feesByPayment?.Coin?.cost
  },
  {
    currency: '',
    weight: t('shipping.routes.countries.menu2.secondHalfKG'),
...
const pricingItems3 = computed(() => [
  {
    ...
    weight: '50-100kg',
    price: 'NTD ' + feeResult3.value?.warehouses?.[0]?.methods?.[1]?.feesByPayment?.Coin?.cost / 100 + '/0.5kg'
  },
  {
    currency: '',
    weight: '101-150kg',
    price: 'NTD ' + feeResult4.value?.warehouses?.[0]?.methods?.[1]?.feesByPayment?.Coin?.cost / 202 + '/0.5kg'
  },
  {
    currency: '',
    weight: t('shipping.routes.countries.menu2.over151KG'),
    price: 'NTD ' + feeResult5.value?.warehouses?.[0]?.methods?.[1]?.feesByPayment?.Coin?.cost / 302 + '/0.5kg'
  }
])
...
const pricingItems4 = computed(() => [
  {
    ...
    weight: '50-100kg',
    price: 'NTD ' + feeResult3.value?.warehouses?.[0]?.methods?.[1]?.feesByPayment?.CreditCard?.cost / 100 + '/0.5kg'
  },
  {
    currency: '',
    weight: '101-150kg',
    price: 'NTD ' + feeResult4.value?.warehouses?.[0]?.methods?.[1]?.feesByPayment?.CreditCard?.cost / 202 + '/0.5kg'
  },
  {
    currency: '',
    weight: t('shipping.routes.countries.menu2.over151KG'),
    price: 'NTD ' + feeResult5.value?.warehouses?.[0]?.methods?.[1]?.feesByPayment?.CreditCard?.cost / 302 + '/0.5kg'
  }
])
...
const pricingItems6 = computed(() => [
  {
    currency: t('shipping.routes.countries.menu2.eurCharge1'),
    weight: t('shipping.routes.countries.menu2.under2p5KG'),
    price: 'EUR 2.5',
  },
  {
    currency: '',
    weight: t('shipping.routes.countries.menu2.over2p5KG'),
    price: 'EUR 0.5',
  }
])
...
const pricingItems9 = computed(() => [
  {
    currency: t('shipping.routes.countries.menu2.eurCharge2'),
