<template>
  <h2 class="text-2xl font-bold text-cyan-400 font-mono tracking-wider mb-2">{{ t('shipping.routes.countries.menu1.outline') }}</h2>
  <div class="space-y-4">
    <div 
...
const processItems = computed(() => [
  {
    item: t('shipping.routes.countries.menu1.item15'),
    content: [
        t('shipping.routes.countries.menu1.content13.row1'),
        t('shipping.routes.countries.menu1.content13.row2'),
        t('shipping.routes.countries.menu1.content13.row3'),
        t('shipping.routes.countries.menu1.content13.row4'),
        t('shipping.routes.countries.menu1.content13.row5'),
        t('shipping.routes.countries.menu1.content13.row6'),
        t('shipping.routes.countries.menu1.content13.row7'),
    ]
  },
  {
    item: t('shipping.routes.countries.menu1.item9'),
    content: [
        t('shipping.routes.countries.menu1.content14.row1'),
        t('shipping.routes.countries.menu1.content14.row2'),
        t('shipping.routes.countries.menu1.content14.row3'),
        t('shipping.routes.countries.menu1.content14.row4'),
        t('shipping.routes.countries.menu1.content14.row5'),
        t('shipping.routes.countries.menu1.content14.row6')
    ]
  },
  {
