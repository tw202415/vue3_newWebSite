...
const pricingItems2 = computed(() => [
  {
    currency: t('shipping.routes.countries.menu2.twdCharge1'),
    weight: t('shipping.routes.countries.menu2.firstKG'),
    price: 'NTD ' + feeResult.value?.warehouses?.[0]?.methods?.[1]?.feesByPayment?.Coin?.cost
  },
  {
    currency: '',
    weight: t('shipping.routes.countries.menu2.secondKG'),
    price: 'NTD ' + (feeResult2.value?.warehouses?.[0]?.methods?.[1]?.feesByPayment?.Coin?.cost - feeResult.value?.warehouses?.[0]?.methods?.[1]?.feesByPayment?.Coin?.cost)
  }
])
...
const pricingItems3 = computed(() => [
  {
    currency: t('shipping.routes.countries.menu2.twdCharge1'),
    weight: t('shipping.routes.countries.menu2.firstKG'),
    price: 'NTD ' + feeResult4.value?.warehouses?.[0]?.methods?.[1]?.feesByPayment?.Coin?.cost / 6
  },
  {
    currency: '',
    weight: t('shipping.routes.countries.menu2.secondKG'),
...
const pricingItems4 = computed(() => [
  {
    currency: t('shipping.routes.countries.menu2.twdCharge1'),
    weight: '50-100kg',
    price: 'NTD ' + feeResult5.value?.warehouses?.[0]?.methods?.[2]?.feesByPayment?.Coin?.cost / 50
  },
  {
    currency: '',
    weight: '101-150kg',
    price: 'NTD ' + feeResult6.value?.warehouses?.[0]?.methods?.[2]?.feesByPayment?.Coin?.cost / 101
  },
  {
    currency: '',
    weight: t('shipping.routes.countries.menu2.over151KG'),
    price: 'NTD ' + feeResult7.value?.warehouses?.[0]?.methods?.[2]?.feesByPayment?.Coin?.cost / 151
  }
])
...
const pricingItems5 = computed(() => [
  {
    currency: t('shipping.routes.countries.menu2.twdCharge2'),
    weight: '50-100kg',
    price: 'NTD ' + feeResult5.value?.warehouses?.[0]?.methods?.[2]?.feesByPayment?.CreditCard?.cost / 50
  },
  {
    currency: '',
    weight: '101-150kg',
    price: 'NTD ' + feeResult6.value?.warehouses?.[0]?.methods?.[2]?.feesByPayment?.CreditCard?.cost / 101
  },
  {
    currency: '',
    weight: t('shipping.routes.countries.menu2.over151KG'),
    price: 'NTD ' + feeResult7.value?.warehouses?.[0]?.methods?.[2]?.feesByPayment?.CreditCard?.cost / 151
  }
])
