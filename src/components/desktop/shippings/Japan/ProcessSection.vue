<template>
  <div class="space-y-4">
    <div 
      ...
      :key="index"
      class="bg-gray-800/50 rounded-lg shadow-lg shadow-orange-500/10 overflow-hidden"
    >
      <button 
      ...
      <div v-show="openFaqs[index]" class="p-6 pt-0">
        ...
        <a class="text-orange-500 hover:text-orange-300 underline transition-colors duration-200" href="https://portal.sw.nat.gov.tw/APGQ/LoginFree?request_locale=zh_TW&breadCrumbs=" v-if="index === 1">{{ t(`shipping.routes.countries.menu1.content2.row7`) }}</a>
      </div>
    </div>
  </div>
</template>
