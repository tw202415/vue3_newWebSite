...
const processItems = computed(() => [
  {
    item: t('shipping.routes.countries.menu1.item6'),
    content: [
        t('shipping.routes.countries.menu1.content5.row1'),
        t('shipping.routes.countries.menu1.content5.row2'),
        t('shipping.routes.countries.menu1.content5.row3'),
        t('shipping.routes.countries.menu1.content5.row4'),
        t('shipping.routes.countries.menu1.content5.row5'),
        t('shipping.routes.countries.menu1.content5.row6'),
        t('shipping.routes.countries.menu1.content5.row7'),
    ]
  },
  {
    item: t('shipping.routes.countries.menu1.item7'),
    content: [
        t('shipping.routes.countries.menu1.content2.row1'),
        t('shipping.routes.countries.menu1.content2.row2'),
        t('shipping.routes.countries.menu1.content2.row3'),
        t('shipping.routes.countries.menu1.content2.row4'),
        t('shipping.routes.countries.menu1.content2.row5'),
        t('shipping.routes.countries.menu1.content2.row6')
    ]
  },
  {
