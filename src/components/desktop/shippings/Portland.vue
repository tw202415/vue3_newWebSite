      ...
      <div class="w-64 bg-gray-800 border-r border-cyan-500/20">
        <div class="p-4 border-b border-cyan-500/20">
          <h2 class="text-xl font-mono font-bold text-cyan-400 tracking-wider">
            {{ t('shipping.routes.countries.portland') }}
          </h2>
        </div>
        <nav class="mt-4">
          <button
...
//桌面
import DesktopProcessSection from '@/components/desktop/shippings/Portland/ProcessSection.vue'
import DesktopPricingSection from '@/components/desktop/shippings/Portland/PricingSection.vue'
import DesktopTimelineSection from '@/components/desktop/shippings/Portland/TimelineSection.vue'

//手機
import MobileProcessSection from '@/components/mobile/shippings/Portland/ProcessSection.vue'
import MobilePricingSection from '@/components/mobile/shippings/Portland/PricingSection.vue'
import MobileTimelineSection from '@/components/mobile/shippings/Portland/TimelineSection.vue'
